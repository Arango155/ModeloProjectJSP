...
@WebServlet(urlPatterns = {"/NewServletCurso"})
public class NewServletCurso extends HttpServlet {
    Curso curso;
    CursoController registroCurso;
     Curso[] CursosRegistrados;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter respuesta = response.getWriter()) {            
            ...
            if(registroCurso==null){
                 registroCurso=new CursoController();
            }
           
            registroCurso.guardarCurso(curso);//almacenarlo en el array
            
           if(registroCurso.getCurso2(curso)){//almacenarlo en BD
               respuesta.println(1);
           }else{
               respuesta.println(0);
           }
